...
subtitle: "Based on the paper Effect size quantification for interrupted time series analysis: Implementation in R and quantifying the relative risk of mortality during Covid-19 in a national population-based cohort"
output: pdf_document
---
